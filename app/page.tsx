...
export default function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="text-center">
            <div className="animate-fade-in">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto">
                ...
                Browse thousands of listings with detailed photos, virtual tours, and more.
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto animate-slide-up px-4">
              <div className="bg-white rounded-xl shadow-2xl p-2 flex flex-col sm:flex-row gap-2">
                ...
                <button className="bg-blue-600 text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-md hover:bg-blue-700 transition-colors font-medium text-sm sm:text-base">
                  Search
                </button>
              </div>
            </div>
      ...
      <div className="container-responsive py-8 sm:py-12 lg:py-16">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How PropRent Works</h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 text-center transform hover:scale-105 transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 0.3}s` }}>
                ...
                <div className="bg-blue-100 text-blue-600 text-sm font-semibold rounded-full px-3 py-1 inline-block mb-3">
                  Step {index + 1}
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {[
            ...
            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 0.2}s` }}>
              ...
              <div className="p-6">
                ...
                <Link href={`/properties/${property.id}`} className="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium text-center block">
                  View Details
                </Link>
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <Link href="/properties" className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium">
      ...
      {/* Agent Section with Pricing */}
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">Join Our Agent Network</h2>
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Why List with PropRent?</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Access to thousands of qualified tenants</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Professional marketing tools</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4 hover:border-blue-500 transition-colors">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-xl font-bold text-blue-600">$49/month</span>
                  </div>
                  <p className="text-gray-600 text-sm">10 properties</p>
                </div>
                <div className="border rounded-lg p-4 hover:border-blue-500 transition-colors">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="font-semibold text-gray-900">Pro Plan</h4>
                    <span className="text-xl font-bold text-blue-600">$99/month</span>
                  </div>
                  <p className="text-gray-600 text-sm">50 properties</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Get the latest listings and exclusive offers delivered to your inbox</p>
